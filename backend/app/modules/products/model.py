...
from sqlalchemy import Boolean, Column, ForeignKey, Integer, Numeric, String, Text, VARCHAR
...
class Product(AuditMixin, SoftDeleteMixin, table=True):
    ...
    image_url: str | None = Field(default=None, sa_column=Column(VARCHAR(500), nullable=True))
